...
def admin_screen(screen):
    ...
    Label(screen6, text="").pack()
    Button(screen6, text="Deactivate", width=10, height=1, command=lambda: LoginController.deleteUser(screen6, otherEmail.get())).pack()
    ...
    Label(screen6, text="").pack()
    Button(screen6, text="Register Employee", width="30", height="2", command=lambda: register(screen)).pack()
    Label(screen6, text="").pack()
